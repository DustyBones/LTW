...
<body>
  <nav>
    <ul>
      ...
      ?> -->
      <li><a id="my_polls" href="myPolls.php">My Polls</a></li>
      <li><a id="new_poll" href="createPoll.php">Create Poll</a></li>
      <li><a id="sign_out" href="process_logout.php">Sign Out</a></li>
      <li><a id="sign_in" href="login.php">Sign In</a></li>
      <li><a id="sign_up" href="register.php">Sign Up</a></li>
    </ul>
  </nav>
